...
\author{{Jos\'e Varela-Ald\'as}\authorrefmark{1},~\IEEEmembership{Senior Member, IEEE}, {Ang\'elica V. Quito}\authorrefmark{2}, {Víctor H. Andaluz}\authorrefmark{3}  and {Alexandre Santos Brandão}\authorrefmark{4},~\IEEEmembership{Member, IEEE}}
...
results are each reported over five repetitions with independent noise and wind
realizations, shown as mean $\pm$ std; the disturbance-free mass-identification
...
The source code and experiment scripts are openly available at \href{https://github.com/bryansgue/observability-aware}{GITHUB}.
