...
%DIF ADD paper_access.tex                Tue Sep  1 19:39:16 2026
\usepackage{cite}
...
hover ($N{=}5$, mean $\pm$ std): the probe (shaded) lifts $\tilde\sigma$ and
recovers the mass, is withdrawn after \SI{15}{\second} of gate-open time, and the
