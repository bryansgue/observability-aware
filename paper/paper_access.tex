...
errors to probe the dominant effects of a real sensor, but a full hardware demonstration,
...
dimensionless measure, comparable across maneuvers, we normalize it by the
...
is an optimal-input design over continuous inputs rather than over a probe family.
