...
%DIF ADD paper_access.tex                Tue Sep  1 19:46:53 2026
\usepackage{cite}
...
\SI{1}{\milli\second} \DIFdelbegin \DIFdel{. Fig.~\ref{fig:traj} shows the }\DIFdelend \DIFaddbegin \DIFadd{on the laptop-class processor of Section~\ref{sec:nmpc}. The }\DIFaddend spatial effect on the figure-eight \DIFaddbegin \DIFadd{is shown in
